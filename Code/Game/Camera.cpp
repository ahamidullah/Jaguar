...
void InitializeCamera(void *parameter) {//Camera *camera, V3 position, V3 forward, f32 speed, f32 field_of_view) {
	GameState *game_state = (GameState *)parameter;
...
void UpdateCamera(Camera *camera, Game_Input *input) {
